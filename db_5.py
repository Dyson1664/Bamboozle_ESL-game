...
#test 3 is the one im working on. Got the dictionary of books with associated units. Check gpt for how they did it: some mapping function. Then see how to add the data to the html